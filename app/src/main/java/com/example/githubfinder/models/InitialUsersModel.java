...
public class InitialUsersModel implements Parcelable{
    ...
    public final static Parcelable.Creator<InitialUsersModel> CREATOR = new Parcelable.Creator<InitialUsersModel>() {

        @SuppressWarnings({"unchecked"})
        public InitialUsersModel createFromParcel(Parcel in) {
            return new InitialUsersModel(in);
        }

        public InitialUsersModel[] newArray(int size) {
            return (new InitialUsersModel[size]);
        }

    };

    protected InitialUsersModel(Parcel in) {
    ...
    public static final DiffUtil.ItemCallback<InitialUsersModel> CALLBACK = new DiffUtil.ItemCallback<InitialUsersModel>() {
        @Override
        public boolean areItemsTheSame(@NonNull InitialUsersModel oldItem, @NonNull InitialUsersModel newItem) {
            return oldItem.id == newItem.id;
        }

        @Override
        public boolean areContentsTheSame(@NonNull InitialUsersModel oldItem, @NonNull InitialUsersModel newItem) {
            return true;
        }
    };
